sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("fss/ssp/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("fss.ssp.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["fss/ssp/localService/mockserver"], function (mockserver) {
