...
sap.ui.define([
	...
	"fss/ssp/controls/upload/UploadSetItem",
	"fss/ssp/controls/upload/Uploader",
	"fss/ssp/controls/upload/UploadSetRenderer",
	"sap/base/i18n/ResourceBundle"
], function (Control, Icon, KeyCodes, Log, deepEqual, MobileLibrary, Button, Dialog, List, MessageBox, OverflowToolbar,
			 StandardListItem, Text, ToolbarSpacer, FileUploader, UploadSetItem, Uploader, Renderer, ResourceBundle) {
	"use strict";
	 ...
	 * @public
	 * @since 1.62
	 * @alias fss.ssp.controls.upload.UploadSet
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel.
	 */
	var UploadSet = Control.extend("fss.ssp.controls.upload.UploadSet", {
		metadata: {
			library: "sap.m",
			properties: {
				/**
			...
			aggregations: {
				 ...
				 */
				items: {type: "fss.ssp.controls.upload.UploadSetItem", multiple: true, singularName: "item"},
				/**
				 * Items representing files yet to be uploaded.
				 */
				incompleteItems: {type: "fss.ssp.controls.upload.UploadSetItem", multiple: true, singularName: "incompleteItem"},
				/**
				 ...
				 */
				uploader: {type: "fss.ssp.controls.upload.Uploader", multiple: false}
			},
			events: {
				/**
				...
				afterItemAdded: {
					parameters: {
						 ...
						 */
						item: {type: "fss.ssp.controls.upload.UploadSetItem"}
					}
				},
				/**
				...
				selectionChanged: {
					parameters: {
						 ...
						 */
						items: {type: "fss.ssp.controls.upload.UploadSetItem[]"}
					}
				}
			}
		}
	...
	if(!MobileLibrary.UploadState){
		MobileLibrary.UploadState = {Complete: "Complete", Error: "Error", Ready: "Ready", Uploading: "Uploading"	};
	}
	...
	UploadSet.prototype.init = function () {
		...
		this._oRb = ResourceBundle.create({
					url : sModelPath + "/controls/upload/messagebundle.properties"
				});
	 ...
	 * @param {fss.ssp.controls.upload.Uploader} oUploader Instance of <code>fss.ssp.controls.upload.Uploader</code> to which the default request handlers are attached.
	 * @public
	 */
