...
sap.ui.define([
	 ...
	 * @public
	 * @since 1.62
	 * @alias fss.ssp.controls.upload.Uploader
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel
	 */
	var Uploader = Element.extend("fss.ssp.controls.upload.Uploader", {
		metadata: {
			library: "sap.m",
			publicMethods: [
				"uploadItem",
	 ...
	 *
	 * @param {fss.ssp.controls.upload.UploadSetItem} oItem Item representing the file to be uploaded.
	 * @param {sap.ui.core.Item[]} [aHeaderFields] Collection of request header fields to be send along.
	 * @public
	 */
	 ...
	 *
	 * @param {fss.ssp.controls.upload.UploadSetItem} oItem Item representing the file whose ongoing upload process is to be terminated.
	 * @public
	 */
	 ...
	 *
	 * @param {fss.ssp.controls.upload.UploadSetItem} oItem Item representing the file to be downloaded.
