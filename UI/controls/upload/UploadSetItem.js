...
sap.ui.define([
	 ...
	 * @class Item that represents one file to be uploaded using the {@link fss.ssp.controls.upload.UploadSet} control.
	 ...
	 * @public
	 * @since 1.62
	 * @alias fss.ssp.controls.upload.UploadSetItem
	 * @ui5-metamodel This control/element also will be described in the UI5 (legacy) designtime metamodel.
	 */
	var UploadSetItem = Element.extend("fss.ssp.controls.upload.UploadSetItem", {
		metadata: {
			library: "sap.m",
			properties: {
				/**
	...
	var DynamicItemContent = HTML.extend("fss.ssp.controls.upload.DynamicItemContent", {
		metadata: {
			library: "sap.m",
			properties: {
				item: {type: "fss.ssp.controls.upload.UploadSetItem"}
	 ...
	 *
	 * @public
	 * @returns {fss.ssp.controls.upload.UploadSetItem} Returns instance for chaining.
	 *
	 */
