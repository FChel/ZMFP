/*!
 * Copied from Open UI5 library version 1.64 as Grouping feature was added.
 */
...
sap.ui.define([
	...
	function(
		 ...
		 */
		var ComboBox = ComboBoxBase.extend("fss.ssp.controls.ComboBox.ComboBox", /** @lends sap.m.ComboBox.prototype */ {
			metadata: {
				library: "sap.m",
		...
		//Extending control's setEnabled function so that it automatically wipes the data when control is disabled.
			ComboBox.prototype.setEnabled = function(enabled){
				ComboBoxBase.prototype.setEnabled.apply(this, arguments);
